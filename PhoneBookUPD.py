    ...
    try:
        ...
        # Quering Data By Parts
            ...
            if result is not None:
                print(f"{n}'s Contact Number:", result[1])
            else:
                print(f"No contact found with the name '{n}'")
            ...
            result = cur.fetchone()
            if result is not None:
                print(f"It's {result[0]}'s Contact Number")
            else:
                print(f"No contact found with the number '{n}'")
